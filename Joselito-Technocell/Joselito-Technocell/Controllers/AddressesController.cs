...
namespace Joselito_Technocell.Controllers
{
    public class AddressesController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "AddressId,StringAddress")] Address address)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "AddressId,StringAddress")] Address address)
        {
            if (ModelState.IsValid)
            {
